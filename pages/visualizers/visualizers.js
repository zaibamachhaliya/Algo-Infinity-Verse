...
const visualizers = [
  ...
  { name: "Chord DHT Ring Simulator", path: "/pages/visualizers/chord-simulator/chord-simulator.html", category: "Distributed Systems", icon: "fa-circle-notch", desc: "Interactive Chord DHT simulator demonstrating finger table dynamic calculation and routing paths." },
  ...
  { name: "Paxos Consensus Protocol Simulator", path: "/pages/visualizers/paxos-simulator/paxos-simulator.html", category: "Distributed Systems", icon: "fa-network-wired", desc: "Interactive Paxos message exchange simulator demonstrating proposal consensus and network partitions." },
